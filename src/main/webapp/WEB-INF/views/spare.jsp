  ...
  <script userUserType="text/javascript">
    ...
    function getSpare(){
      $.ajax({
        ...
        jQuery("#result").html("</br><button class=\"btn btn-info\"  userUserType=\"button\" onclick=\"openSpare()\">Добавить запчасть</button></br><table class=\"table table-hover\" id=\"params_t\">\n\
               </br>\
<thead>\n\
          ...
          <table>
            <form:form method="POST" modelAttribute="spareForm" >
              ...
              <tr>
                ...
                <td><form:input path="price" id="work_hour3" userUserType="number"/>
              ...
              <tr>
                ...
                <td><form:input path="amount_in_stock" id="work_hour5" userUserType="number"/>
