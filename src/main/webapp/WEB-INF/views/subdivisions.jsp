  ...
  <script userUserType="text/javascript">
    ...
    function getSubdivision(){
      $.ajax({
        ...
        jQuery("#result").html("</br><button class=\"btn btn-info\"  userUserType=\"button\" onclick=\"openSubdivision()\">Добавить цех</button></br><table class=\"table table-hover\" id=\"params_t\">\n\
               </br>\
<thead>\n\
