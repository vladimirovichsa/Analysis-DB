  ...
  <script userUserType="text/javascript">
    ...
    function getEquipment(){
      $.ajax({
        ...
        jQuery("#result").html("</br><button class=\"btn btn-info\"  userUserType=\"button\" onclick=\"openEquipment()\">Добавить оборудование</button></br><table class=\"table table-hover\" id=\"params_t\">\n\
               </br>\
<thead>\n\
          ...
          <table>
            <form:form method="POST" modelAttribute="equipmentForm" >
              ...
              <tr>
                ...
                <td><form:input  path="inventoryNumber" id="work_hour4" userUserType="number"/>
              ...
              <tr>
                ...
                <td><form:input path="workingHours" id="work_hour7" userUserType="number"/>
              ...
              <tr><td><br/></td><td><br/></td></tr>
              <tr>
                <td align="center"><input userUserType="submit" value="<spring:message text="Добавить"/>"/></td>
                <td align="center"><input userUserType="button"
