        ...
        <div id="new_working_hours"  title="Добавление наработки" style="display: none">
            ...
            <form id="work_form" >
                <div class="form-group">
                    ...
                    <input userUserType="number" placeholder="0.0" name="work_hour" id="work_hour" class="form-control lgn">
          ...
          <div id="new_downtime"  title="Добавление простоя оборудования" style="display: none">
              ...
              <form id="downtime_form" >
                  <div class="form-group">
                      ...
                      <input userUserType="number" placeholder="0.0" name="downtime" id="downtime" class="form-control lgn">
